...
class NuscData(torch.utils.data.Dataset):
    def __init__(self, nusc, is_train, data_aug_conf, grid_conf, data_root):
        self.nusc: NuScenes = nusc
        self.is_train: bool = is_train
        self.data_aug_conf: Dict[str, Any] = data_aug_conf
        self.grid_conf: Dict[str, List[float]] = grid_conf
        self.dataroot: str = data_root

        self.scenes: List[str] = self.get_scenes()
